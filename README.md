...
Get node count and complexity for a single page:
...
Get node counts for all pages under a root path:
...
|-----------|-------------|---------|
| path | Single page path to analyze | - |
| rootPath | Root path for multiple pages | - |
| limit | Max pages to return (for rootPath) | 100 |
| highThreshold | Custom high threshold | 2048 |
| mediumThreshold | Custom medium threshold | 1024 |
